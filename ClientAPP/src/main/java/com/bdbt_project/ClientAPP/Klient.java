...
public class Klient {
  ...
  public Klient(){
    ...
    public Klient(int Nr_klienta, String imie_klienta, String nazwisko_klienta, String plec_klienta, Timestamp data_urodzenia_klienta, String PESEL_klienta, String email_klienta, String nr_telefonu_klienta, int nr_zarzadu, int nr_adresu, int nr_poczty) {
        super();
